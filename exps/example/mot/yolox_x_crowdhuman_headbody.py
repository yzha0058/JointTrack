...
class Exp(MyExp):
    ...
    def get_model(self):
        from yolox.models import YOLOPAFPN, YOLOX, YOLOXHead2
        ...
        if getattr(self, "model", None) is None:
            ...
            head = YOLOXHead2(self.num_classes, self.width, in_channels=in_channels)
    ...
    def get_data_loader(self, batch_size, is_distributed, no_aug=False):
        ...
        dataset = MOTDataset(
            data_dir=os.path.join(get_yolox_datadir(), "crowdhuman_o"),
            json_file=self.train_ann,
            name='',
            img_size=self.input_size,
            preproc=TrainTransform2(
