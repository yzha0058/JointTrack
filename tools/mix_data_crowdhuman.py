...
"""
cd datasets
mkdir -p crowdhuman_o/annotations
cp crowdhuman/annotations/val.json crowdhuman_o/annotations/val.json
cp HT21/annotations/test.json crowdhuman_o/annotations/test.json
cd mix_crowdhuman_ch
ln -s ../HT21/train ht21_train
ln -s ../crowdhuman/CrowdHuman_train crowdhuman_train
ln -s ../crowdhuman/CrowdHuman_val crowdhuman_val
cd ..
"""

mot_json = json.load(open('datasets/HT21/annotations/train.json', 'r'))

img_list = list()
# for img in mot_json['images']:
#     img['file_name'] = 'ht21_train/' + img['file_name']
#     img_list.append(img)
...
json.dump(mix_json, open('datasets/crowdhuman_o/annotations/train.json', 'w'))