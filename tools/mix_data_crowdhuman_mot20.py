...
"""
cd datasets
mkdir -p mix_crowdhuman_ch/annotations
cp crowdhuman/annotations/val.json mix_crowdhuman_ch/annotations/val.json
...
json.dump(mix_json, open('datasets/mix_crowdhuman_ch/annotations/train.json', 'w'))