...
"""
cd datasets
mkdir -p mix_ht21_ch/annotations
cp HT21/annotations/val_half.json mix_ht21_ch/annotations/val_half.json
cp HT21/annotations/test.json mix_ht21_ch/annotations/test.json
cd mix_ht21_ch
...
json.dump(mix_json, open('datasets/mix_ht21_ch/annotations/train.json', 'w'))